...
class CT_Tc(BaseOxmlElement):
    ...
    def _swallow_next_tc(self, grid_width, top_tc):
        ...
        appended to the content of *top_tc*. Raises |InvalidSpanError| if the
        width of the resulting cell is greater than *grid_width* or if there
        is no next `<w:tc>` element in the row.
        """
